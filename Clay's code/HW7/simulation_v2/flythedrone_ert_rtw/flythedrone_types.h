...
#ifndef RTW_HEADER_flythedrone_types_h_
#define RTW_HEADER_flythedrone_types_h_
#include "rtwtypes.h"
...
typedef struct P_MeasurementUpdate_flythedro_T_ P_MeasurementUpdate_flythedro_T;

/* Parameters for system: '<S39>/Enabled Subsystem' */
typedef struct P_EnabledSubsystem_flythedron_T_ P_EnabledSubsystem_flythedron_T;

/* Parameters (default storage) */
typedef struct P_flythedrone_T_ P_flythedrone_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_flythedrone_T RT_MODEL_flythedrone_T;

#endif                                 /* RTW_HEADER_flythedrone_types_h_ */
